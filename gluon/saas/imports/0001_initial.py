...
import base.fields
from util.fields import StatusField
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dependencies', models.ManyToManyField(help_text='List of modules required to make this one work', related_name='dependencies_rel_set', verbose_name='Dependencies', to='saas.Module')),
                ('status', StatusField(related_name='status_saas_module_set', default=None, verbose_name='status', to='util.Status')),
            ],
            options={
                'verbose_name': 'module',
