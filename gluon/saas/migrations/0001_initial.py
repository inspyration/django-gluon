    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(upload_to='saas/logos/%Y/%m/%d', help_text='Logo of the instance owner', max_length=64, width_field=models.PositiveSmallIntegerField(verbose_name='logo width'), height_field=models.PositiveSmallIntegerField(verbose_name='logo height'), verbose_name='logo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(upload_to='saas/avatars/%Y/%m/%d', help_text='Avatar', max_length=64, width_field=models.PositiveSmallIntegerField(verbose_name='avatar width'), height_field=models.PositiveSmallIntegerField(verbose_name='avatar height'), verbose_name='avatar')),
